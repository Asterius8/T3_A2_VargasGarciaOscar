...
class Ventana extends JFrame{
	...
	public Ventana() {
		...
		for(int i=0; i<10000000; i++) { //Me explota el PC con 10M de datos pero se cambia el i a 10000000 (Nota se cambia tambien en un set maximum y en la variable "b" en la clase ProgresBar)
